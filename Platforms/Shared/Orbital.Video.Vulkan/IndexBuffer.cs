...
namespace Orbital.Video.Vulkan
{
	public sealed class IndexBuffer : IndexBufferBase
	{
		...
		private static extern IntPtr Orbital_Video_Vulkan_IndexBuffer_Create(IntPtr device, IndexBufferMode mode);

		[DllImport(Instance.lib, CallingConvention = Instance.callingConvention)]
		private static unsafe extern int Orbital_Video_Vulkan_IndexBuffer_Init(IntPtr handle, void* indices, uint indexCount, uint indexSize);
		...
		public unsafe bool Init(uint indexCount, IndexBufferSize indexSize)
		{
			...
			return Orbital_Video_Vulkan_IndexBuffer_Init(handle, null, indexCount, (uint)indexSize) != 0;
		}
		...
		public unsafe bool Init(ushort[] indices)
		{
			...
			{
				return Orbital_Video_Vulkan_IndexBuffer_Init(handle, indicesPtr, (uint)indices.LongLength, (uint)indexSize) != 0;
			}
		}
		...
		public override void Dispose()
		{
			...
			{
				Orbital_Video_Vulkan_IndexBuffer_Dispose(handle);
				handle = IntPtr.Zero;
			}
		}
	}
