...
namespace Orbital.Video
{
	...
	public abstract class DeviceBase : IDisposable
	{
		...
		public abstract Texture2DBase CreateRenderTexture2D(TextureFormat format, int width, int height, TextureMode mode);
		public abstract Texture2DBase CreateRenderTexture2D(TextureFormat format, int width, int height, byte[] data, TextureMode mode);
