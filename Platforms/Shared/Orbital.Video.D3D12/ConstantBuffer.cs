...
namespace Orbital.Video.D3D12
{
	public sealed class ConstantBuffer : ConstantBufferBase
	{
		...
		{
			return Orbital_Video_D3D12_ConstantBuffer_BeginUpdate(handle, activeNodeIndex) != 0;
		}

		public override void EndUpdate()
		{
			Orbital_Video_D3D12_ConstantBuffer_EndUpdate(handle, activeNodeIndex);
		}

		#if CS_7_3
		public unsafe override void Update<T>(T data)
		{
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, &data, (uint)Marshal.SizeOf<T>(), 0, activeNodeIndex);
		}

		public unsafe override void Update<T>(T data, int offset)
		{
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, &data, (uint)Marshal.SizeOf<T>(), (uint)offset, activeNodeIndex);
		}
		...
		public unsafe override void Update<T>(T[] data, int offset)
		{
			...
			{
				Orbital_Video_D3D12_ConstantBuffer_Update(handle, dataPtr, (uint)(Marshal.SizeOf<T>() * data.Length), (uint)offset, activeNodeIndex);
			}
		}
		...
		public unsafe override void Update<T>(T data)
		{
			...
			ptr += Marshal.SizeOf(typeof(RuntimeTypeHandle));
			#endif
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, ptr, (uint)Marshal.SizeOf<T>(), 0, activeNodeIndex);
		}
		...
		public unsafe override void Update<T>(T data, int offset)
		{
			...
			ptr += Marshal.SizeOf(typeof(RuntimeTypeHandle));
			#endif
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, ptr, (uint)Marshal.SizeOf<T>(), (uint)offset, activeNodeIndex);
		}
		...
		public unsafe override void Update<T>(T[] data, int offset)
		{
			...
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, (void*)dataPtr, (uint)(Marshal.SizeOf<T>() * data.Length), (uint)offset, activeNodeIndex);
			gcHandle.Free();
		}
		...
		{
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, data, (uint)dataSize, (uint)offset, activeNodeIndex);
		}

		public override unsafe void Update(float value, int offset)
		{
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, &value, sizeof(float), (uint)offset, activeNodeIndex);
		}

		public override unsafe void Update(Vec2 vector, int offset)
		{
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, &vector, (uint)Marshal.SizeOf<Vec2>(), (uint)offset, activeNodeIndex);
		}

		public override unsafe void Update(Vec3 vector, int offset)
		{
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, &vector, (uint)Marshal.SizeOf<Vec3>(), (uint)offset, activeNodeIndex);
		}

		public override unsafe void Update(Vec4 vector, int offset)
		{
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, &vector, (uint)Marshal.SizeOf<Vec4>(), (uint)offset, activeNodeIndex);
		}

		public override unsafe void Update(Mat2 matrix, int offset)
		{
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, &matrix, (uint)Marshal.SizeOf<Mat2>(), (uint)offset, activeNodeIndex);
		}
		...
		{
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, &matrix, (uint)Marshal.SizeOf<Mat4>(), (uint)offset, activeNodeIndex);
		}

		public override unsafe void Update(Quat quaternion, int offset)
		{
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, &quaternion, (uint)Marshal.SizeOf<Quat>(), (uint)offset, activeNodeIndex);
		}

		public override unsafe void Update(Color4 color, int offset)
		{
			var colorVec = color.ToVec4();
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, &colorVec, (uint)Marshal.SizeOf<Vec4>(), (uint)offset, activeNodeIndex);
		}
		...
		{
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, &vector, (uint)Marshal.SizeOf<Vec2>(), (uint)variable.offset, activeNodeIndex);
		}
		...
		{
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, &vector, (uint)Marshal.SizeOf<Vec4>(), (uint)variable.offset, activeNodeIndex);
		}

		public override unsafe void Update(Mat2 matrix, ShaderVariableMapping variable)
		{
			Orbital_Video_D3D12_ConstantBuffer_Update(handle, &matrix, (uint)Marshal.SizeOf<Mat2>(), (uint)variable.offset, activeNodeIndex);
		}
		...
		public override unsafe void Update(float[] values, int offset)
		{
			...
			fixed (float* ptr = values) Orbital_Video_D3D12_ConstantBuffer_UpdateArray(handle, ptr, sizeof(float), (uint)values.Length, (uint)offset, srcStride, dstStride, activeNodeIndex);
		}
		...
		public override unsafe void Update(Vec2[] vectors, int offset)
		{
			...
			fixed (Vec2* ptr = vectors) Orbital_Video_D3D12_ConstantBuffer_UpdateArray(handle, ptr, (uint)Marshal.SizeOf<Vec2>(), (uint)vectors.Length, (uint)offset, srcStride, dstStride, activeNodeIndex);
		}
		...
		public override unsafe void Update(Vec3[] vectors, int offset)
		{
			...
			fixed (Vec3* ptr = vectors) Orbital_Video_D3D12_ConstantBuffer_UpdateArray(handle, ptr, (uint)Marshal.SizeOf<Vec3>(), (uint)vectors.Length, (uint)offset, srcStride, dstStride, activeNodeIndex);
		}
		...
		public override unsafe void Update(Vec4[] vectors, int offset)
		{
			...
			fixed (Vec4* ptr = vectors) Orbital_Video_D3D12_ConstantBuffer_UpdateArray(handle, ptr, (uint)Marshal.SizeOf<Vec4>(), (uint)vectors.Length, (uint)offset, srcStride, dstStride, activeNodeIndex);
		}
		...
		public override unsafe void Update(Mat2[] matrices, int offset)
		{
			...
			fixed (Mat2* ptr = matrices) Orbital_Video_D3D12_ConstantBuffer_UpdateArray(handle, ptr, (uint)Marshal.SizeOf<Mat2>(), (uint)matrices.Length, (uint)offset, srcStride, dstStride, activeNodeIndex);
		}
		...
		public override unsafe void Update(Mat2x3[] matrices, int offset)
		{
			...
			fixed (Mat2x3* ptr = matrices) Orbital_Video_D3D12_ConstantBuffer_UpdateArray(handle, ptr, (uint)Marshal.SizeOf<Mat2x3>(), (uint)matrices.Length, (uint)offset, srcStride, dstStride, activeNodeIndex);
		}
		...
		public override unsafe void Update(Mat3[] matrices, int offset)
		{
			...
			fixed (Mat3* ptr = matrices) Orbital_Video_D3D12_ConstantBuffer_UpdateArray(handle, ptr, (uint)Marshal.SizeOf<Mat3>(), (uint)matrices.Length, (uint)offset, srcStride, dstStride, activeNodeIndex);
		}
		...
		public override unsafe void Update(Mat3x2[] matrices, int offset)
		{
			...
			fixed (Mat3x2* ptr = matrices) Orbital_Video_D3D12_ConstantBuffer_UpdateArray(handle, ptr, (uint)Marshal.SizeOf<Mat3x2>(), (uint)matrices.Length, (uint)offset, srcStride, dstStride, activeNodeIndex);
		}
		...
		public override unsafe void Update(Mat4[] matrices, int offset)
		{
			...
			fixed (Mat4* ptr = matrices) Orbital_Video_D3D12_ConstantBuffer_UpdateArray(handle, ptr, (uint)Marshal.SizeOf<Mat4>(), (uint)matrices.Length, (uint)offset, srcStride, dstStride, activeNodeIndex);
		}
		...
		public override unsafe void Update(Quat[] quaternions, int offset)
		{
			uint srcStride = (uint)ShaderBase.VariableTypeToSrcStride(ShaderVariableType.Float4);
			uint dstStride = (uint)ShaderBase.VariableTypeToDstStride(ShaderVariableType.Float4);
			fixed (Quat* ptr = quaternions) Orbital_Video_D3D12_ConstantBuffer_UpdateArray(handle, ptr, (uint)Marshal.SizeOf<Quat>(), (uint)quaternions.Length, (uint)offset, srcStride, dstStride, activeNodeIndex);
		}
		...
		public override unsafe void Update(Color4[] colors, int offset)
		{
			...
			uint dstStride = (uint)ShaderBase.VariableTypeToDstStride(ShaderVariableType.Float4);
			fixed (Color4* ptr = colors) Orbital_Video_D3D12_ConstantBuffer_UpdateColorArray(handle, ptr, (uint)Marshal.SizeOf<Color4>(), (uint)colors.Length, (uint)offset, srcStride, dstStride, activeNodeIndex);
		}
		...
		public override unsafe void Update(Vec2[] vectors, ShaderVariableMapping variable)
		{
			uint srcStride = (uint)ShaderBase.VariableTypeToSrcStride(ShaderVariableType.Float2);
			uint dstStride = (uint)ShaderBase.VariableTypeToDstStride(ShaderVariableType.Float2);
			fixed (Vec2* ptr = vectors) Orbital_Video_D3D12_ConstantBuffer_UpdateArray(handle, ptr, (uint)Marshal.SizeOf<Vec2>(), (uint)vectors.Length, (uint)variable.offset, srcStride, dstStride, activeNodeIndex);
		}
		...
		public override unsafe void Update(Vec4[] vectors, ShaderVariableMapping variable)
		{
			uint srcStride = (uint)ShaderBase.VariableTypeToSrcStride(ShaderVariableType.Float4);
			uint dstStride = (uint)ShaderBase.VariableTypeToDstStride(ShaderVariableType.Float4);
			fixed (Vec4* ptr = vectors) Orbital_Video_D3D12_ConstantBuffer_UpdateArray(handle, ptr, (uint)Marshal.SizeOf<Vec4>(), (uint)vectors.Length, (uint)variable.offset, srcStride, dstStride, activeNodeIndex);
		}
		...
		public override unsafe void Update(Mat2[] matrices, ShaderVariableMapping variable)
		{
			uint srcStride = (uint)ShaderBase.VariableTypeToSrcStride(ShaderVariableType.Float2x2);
			uint dstStride = (uint)ShaderBase.VariableTypeToDstStride(ShaderVariableType.Float2x2);
			fixed (Mat2* ptr = matrices) Orbital_Video_D3D12_ConstantBuffer_UpdateArray(handle, ptr, (uint)Marshal.SizeOf<Mat2>(), (uint)matrices.Length, (uint)variable.offset, srcStride, dstStride, activeNodeIndex);
		}
		...
		public override unsafe void Update(Mat2x3[] matrices, ShaderVariableMapping variable)
		{
			uint srcStride = (uint)ShaderBase.VariableTypeToSrcStride(ShaderVariableType.Float2x3);
			uint dstStride = (uint)ShaderBase.VariableTypeToDstStride(ShaderVariableType.Float2x3);
			fixed (Mat2x3* ptr = matrices) Orbital_Video_D3D12_ConstantBuffer_UpdateArray(handle, ptr, (uint)Marshal.SizeOf<Mat2x3>(), (uint)matrices.Length, (uint)variable.offset, srcStride, dstStride, activeNodeIndex);
		}
		...
		public override unsafe void Update(Mat3[] matrices, ShaderVariableMapping variable)
		{
			uint srcStride = (uint)ShaderBase.VariableTypeToSrcStride(ShaderVariableType.Float3x3);
			uint dstStride = (uint)ShaderBase.VariableTypeToDstStride(ShaderVariableType.Float3x3);
			fixed (Mat3* ptr = matrices) Orbital_Video_D3D12_ConstantBuffer_UpdateArray(handle, ptr, (uint)Marshal.SizeOf<Mat3>(), (uint)matrices.Length, (uint)variable.offset, srcStride, dstStride, activeNodeIndex);
		}
		...
		public override unsafe void Update(Mat4[] matrices, ShaderVariableMapping variable)
		{
			uint srcStride = (uint)ShaderBase.VariableTypeToSrcStride(ShaderVariableType.Float4x4);
			uint dstStride = (uint)ShaderBase.VariableTypeToDstStride(ShaderVariableType.Float4x4);
			fixed (Mat4* ptr = matrices) Orbital_Video_D3D12_ConstantBuffer_UpdateArray(handle, ptr, (uint)Marshal.SizeOf<Mat4>(), (uint)matrices.Length, (uint)variable.offset, srcStride, dstStride, activeNodeIndex);
		}
